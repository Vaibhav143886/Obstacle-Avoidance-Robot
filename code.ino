...
void loop() {
   ...
   Front_D = distanceSensor.measureDistanceCm(); // measuring front distance  
   if (Front_D < Max_D)
   {
     Stop();
     Get_D();     
...
void Get_D(){
    ...
    delay(500);
    Right_D = distanceSensor.measureDistanceCm();     //Measure Right Distance
    Servo_1.write(90);  // Front Positon 
    delay(500);
    Front_D = distanceSensor.measureDistanceCm();     //Measure Front Distance
    Servo_1.write(180); // Left position of servo
    delay(500);
    Left_D = distanceSensor.measureDistanceCm();  //Measure Left Distance
